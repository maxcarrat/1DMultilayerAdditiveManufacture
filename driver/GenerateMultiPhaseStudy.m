...
for modes=1:3
    formatSpec = 'myXFEMMultiPhaseResultsFile_IntegrationM+5_%d.txt';
    XFEMFileID = sprintf(formatSpec,modes);
    XFEMFile = fopen(XFEMFileID, 'r');
    XFEMTemperatureSolution = dlmread(XFEMFileID);
    
    formatSpec = 'myXFEMMultiPhaseFluxesFile_IntegrationM+5_%d.txt';
    XFEMFileID = sprintf(formatSpec,modes);
    XFEMFile = fopen(XFEMFileID, 'r');
    XFEMFluxSolution = dlmread(XFEMFileID);
...
figure(99999)
formatSpec = 'myXFEMMultiPhaseTimeFile_IntegrationM+5_1.txt';
...
formatSpec = 'myXFEMMultiPhaseTimeFile_IntegrationM+5_3.txt';
XFEMTimeFileID = sprintf(formatSpec,modes);
XFEMTime = dlmread(XFEMTimeFileID);
t = linspace(0, numel(XFEMTime), numel(XFEMTime)-1);
