function [ eXtendedBasisFuns ] = PODEnrichedBasis( x, i, iMode, derivativeXBasis, derivativeLinearBasis, coarseProblem, enrichedElementCoords )
%% X-FEM Basis 
...
if(i==1)
    ...
    g = problem.rbBasis_fun( nodeLocalCoord, iMode, 0.0, problem, enrichedElementCoords );
...
N = problem.localBasis_fun(x, i, 0.0, problem, enrichedElementCoords);
...
B = problem.localBasis_fun(x, i, 1.0, problem, enrichedElementCoords);
