function [ solution, convergenceFlag ] = solveMultiPhaseXFEMProblem( problem, time, timeStepSize, integrationOrder,...
...
for i=1:maxNumberOfIterations
   ...
   [M, K, f] = assemblyMultiPhaseXFEMSystem(problem, time, integrationOrder,...
