        ...
        for integrationSubDomainIndex =...
            ...
            if rGP(iGP) <= integrationDomain(integrationSubDomainIndex + 1) &&...
                ...
                M_FEM(overlayProblem.LM(e,:), overlayProblem.LM(e,:)) =...
                    M_FEM(overlayProblem.LM(e,:), overlayProblem.LM(e,:)) +...
                    overlayProblem.heatCapacity(globalGPCoord, evaluateTemperature(integrationSubDomainIndex, e, rGP(iGP), overlayProblem, baseProblem,...
                    overlaySolutionCoefficients, baseSolutionCoefficients), ...
                    evaluateTemperature(integrationSubDomainIndex, e, rGP(iGP), overlayProblem, baseProblem, lastConvergentOverlaySolution, lastConvergedBaseSolution)) *...
                ...
                MPrime_FEM(overlayProblem.LM(e,:), overlayProblem.LM(e,:)) =...
                    MPrime_FEM(overlayProblem.LM(e,:), overlayProblem.LM(e,:)) +...
                    overlayProblem.heatCapacityDerivative( globalGPCoord, evaluateTemperature(integrationSubDomainIndex, e, rGP(iGP), overlayProblem, baseProblem, ...
                    overlaySolutionCoefficients, baseSolutionCoefficients), ...
                    evaluateTemperature(integrationSubDomainIndex, e, rGP(iGP), overlayProblem, baseProblem,lastConvergentOverlaySolution, lastConvergedBaseSolution)) *...
                    (N' * N) * (Nsplines(baseProblem.LM(end, 1:ldof_b)) * deltaBaseSolution(baseProblem.LM(end, 1:ldof_b))...
                    + NTotal * deltaOverlaySolution(overlayProblem.LMBC(elementEnrichedIndex,1:modalDofs+2))) * wGP(iGP) * detJacobianLocalToGlobal;
                ...
                KPrime_FEM(overlayProblem.LM(e,:), overlayProblem.LM(e,:)) =...
                    ...
                    + BTotal * overlaySolutionCoefficients(overlayProblem.LMBC(elementEnrichedIndex,1:modalDofs+2))) * wGP(iGP) *  detJacobianLocalToGlobal;
                ...
                M_Coupling(overlayProblem.LME(elementEnrichedIndex,1:modalDofs), overlayProblem.LMC(elementEnrichedIndex, :)) =...
                    M_Coupling(overlayProblem.LME(elementEnrichedIndex,1:modalDofs), overlayProblem.LMC(elementEnrichedIndex, :)) +...
                    overlayProblem.heatCapacity( globalGPCoord, evaluateTemperature(integrationSubDomainIndex, e, rGP(iGP), overlayProblem, baseProblem, overlaySolutionCoefficients, baseSolutionCoefficients), ...
                    evaluateTemperature(integrationSubDomainIndex, e, rGP(iGP), overlayProblem, baseProblem, lastConvergentOverlaySolution, lastConvergedBaseSolution)) *...
                ...
                MPrime_Coupling(overlayProblem.LME(elementEnrichedIndex,1:modalDofs), overlayProblem.LMC(elementEnrichedIndex, :)) =...
                    MPrime_Coupling(overlayProblem.LME(elementEnrichedIndex,1:modalDofs), overlayProblem.LMC(elementEnrichedIndex, :)) +...
                    overlayProblem.heatCapacityDerivative( globalGPCoord,...
                    evaluateTemperature(integrationSubDomainIndex, e, rGP(iGP), overlayProblem, baseProblem,...
                    overlaySolutionCoefficients, baseSolutionCoefficients), ...
                    evaluateTemperature(integrationSubDomainIndex, e, rGP(iGP), overlayProblem, baseProblem,lastConvergentOverlaySolution, lastConvergedBaseSolution)) *...
                ...
                MPrime_XFEM(overlayProblem.LME(elementEnrichedIndex, 1:modalDofs), overlayProblem.LME(elementEnrichedIndex, 1:modalDofs)) =...
                    MPrime_XFEM(overlayProblem.LME(elementEnrichedIndex, 1:modalDofs), overlayProblem.LME(elementEnrichedIndex, 1:modalDofs)) +...
                    overlayProblem.heatCapacityDerivative( globalGPCoord, evaluateTemperature(integrationSubDomainIndex, e, rGP(iGP), overlayProblem, baseProblem,overlaySolutionCoefficients, baseSolutionCoefficients), ...
                    evaluateTemperature(integrationSubDomainIndex, e, rGP(iGP), overlayProblem, baseProblem,lastConvergentOverlaySolution, lastConvergedBaseSolution)) *...
