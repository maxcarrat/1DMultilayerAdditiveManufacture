function [ M_bb, Mprime_bb, K_bb, Kprime_bb, f_b ] = assemblyMultiscaleBaseXIGA(overlayProblem, baseProblem, time,...
    ...
    lastConvergentBaseSolution, lastConvergentOverlaySolution, initialTemperature)
...
for k=1:length(x)
    ...
    [F, ~] = PODModesAndDerivativesMultiscale(localCoords(k), elementGlobalCoords, overlayProblem.modes,...
