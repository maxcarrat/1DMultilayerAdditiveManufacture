function [ refinedMesh ] = extractControlPoint( mesh, refinementDepth, layer, numberOfLayers, p )
%EXTRACTCONTROLPOINT refine the elements layer of the initial mesh up to a given depth
...
refinedActiveElement = linspace(activeMesh(end-numberOfElementsPerLayer), activeMesh(end), numberOfElementsPerLayer*2^(refinementDepth)+ p);
