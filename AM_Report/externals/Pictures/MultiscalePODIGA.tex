...
%draw enriched layer discretization
	  ...
	  \begin{axis}[minor tick num=1,
			  ...
			  xlabel=$\xi$,
			  at = {(1245.0,-3875)}]
	    \addplot [gray!75,thin] table [x={x}, y={mode_1}] {\PODModes};
		\addplot [dashed,gray!95,thin] table [x={x}, y={mode_2}] {\PODModes};
		\addplot [dotted,black,thin] table [x={x}, y={mode_3}] {\PODModes};
	  \end{axis}
