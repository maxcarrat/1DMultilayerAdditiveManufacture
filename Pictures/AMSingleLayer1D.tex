...
\begin{tikzpicture}
    [ tdplot_main_coords,
      bar/.style={black,draw=black, fill=gray!70, fill opacity=0.25},
      side/.style={black,draw=black, fill=gray!70, fill opacity=0.5},
...
%
  ...
  \draw[black, thin] (2.5,2,0.5) -- ++(-1.35,0.0,0);
  \draw[black, thin] (2.5,3,0.5) -- ++(-1.35,0.0,0) ;
  \draw[dim] (1.25,2,0.5) -- ++(0,1,0.0)node[ align=center, midway, yshift=-0.0, xshift=0.0, above, sloped] {\small $0.05$} ;
