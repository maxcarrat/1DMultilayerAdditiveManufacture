...
\begin{tikzpicture}
    [ timebar/.style={black,draw=black, fill=black, fill opacity=1},
      bar/.style={black,draw=black, fill=black, fill opacity=1, thick},
...
%insert bar evolution pics
	  ...
	  \draw[bar]   (0.9*2, 0.5, 0.0) node[below] {\tiny $\theta_{min} = 20^{\circ}C$} -- (0.9*2, 1.5, 0.0) node[above] {\tiny $\Delta \theta_{max} = 0.0^{\circ}C$};
	  \draw[arrow] (1.1*2, 0.75, 0.0) -- (2.1*2, 0.75, 0.0) node[midway, below] {\tiny {cooling} };
	  \draw[bar]   (2.25*2, 0.5, 0.0) node[below] {\tiny $\theta_{min} = 20^{\circ}C$} -- (2.25*2, 1.5, 0.0) node[above] {\tiny $\Delta \theta_{max} = 0.0^{\circ}C$};
