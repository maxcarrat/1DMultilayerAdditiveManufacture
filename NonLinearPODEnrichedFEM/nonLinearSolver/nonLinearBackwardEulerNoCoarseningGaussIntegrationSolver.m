function [temperaturePostProcessing, heatFluxes, internalEnergy] = nonLinearBackwardEulerNoCoarseningGaussIntegrationSolver(coords, postProcessingCoords, rhs, initialTemperature, leftDirichletBoundaryConditionValue,...
